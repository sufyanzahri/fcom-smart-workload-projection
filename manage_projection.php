						...
						<tbody>
							...
							while ($row = mysqli_fetch_array($sql)) {
								...
								echo "<tr>
										...
										<td>$row[batch]</td>
										<td>
											<a href='manage_semester_batch_projection.php?program_code=$row[program_code]&session_id=$row[session_id]&semester_id=$row[semester_id]&batch=$row[batch]'
											   data-toggle='tooltip' data-placement='left' title='View'>
											   <i class='hgi-stroke hgi-view text-success'></i> View
											</a>
